...
export default function OnboardingClient({ userName }: OnboardingClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#070d14] to-[#0b1a24] flex flex-col items-center justify-center px-6 py-12">
      <div className="max-w-2xl w-full">
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4 text-left bg-white/5 border border-white/10 rounded-2xl p-8">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 font-bold">1</div>
                <div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-gradient-to-r from-emerald-400 to-cyan-500 text-gray-900 font-bold text-base hover:from-emerald-300 hover:to-cyan-400 transition-all shadow-lg shadow-emerald-500/30 flex items-center justify-center gap-2"
            >
              Começar agora
            ...
            <div className="space-y-4 bg-white/5 border border-white/10 rounded-2xl p-8">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/10 text-white placeholder:text-white/40 focus:outline-none focus:border-emerald-400"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-3 rounded-xl bg-gradient-to-r from-emerald-400 to-cyan-500 text-gray-900 font-bold hover:from-emerald-300 hover:to-cyan-400 disabled:opacity-60 transition-all shadow-lg shadow-emerald-500/30 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
        ...
        {step === "sale" && (
          <div className="space-y-8 text-center">
            ...
            <div className="bg-gradient-to-br from-emerald-500/20 to-cyan-600/20 border border-emerald-500/30 rounded-2xl p-8 space-y-4">
            ...
            <div className="space-y-3">
              <Link
                ...
                className="inline-flex w-full items-center justify-center gap-2 py-3 px-8 rounded-xl bg-gradient-to-r from-emerald-400 to-cyan-500 text-gray-900 font-bold hover:from-emerald-300 hover:to-cyan-400 transition-all shadow-lg shadow-emerald-500/30"
              >
                Ir para Vendas
                <ChevronRight size={20} />
              </Link>
